...
/**
 * Add attributes to call and invoke LLVM instructions.
 */
...
/**
 * Add attributes to LLVM function declaration. Useful in conjuction with
 * [LlvmCallSiteAttributeProvider] to make sure that these attributes are actually
...
/**
 * Prototype of a virtual function. There is no LLVM declaration to take attributes from,
 * but we might infer them from IrFunction that represents virtual callee.
 */
