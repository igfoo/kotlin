...
template <ThreadStateHandling Handling, ThreadState State>
class Mode {
public:
    using Lock = SpinLock<Handling>;
    static constexpr ThreadStateHandling threadStateHandling = Handling;
...
using TestModes = testing::Types<
        Mode<ThreadStateHandling::kIgnore, ThreadState::kRunnable>,
        Mode<ThreadStateHandling::kIgnore, ThreadState::kNative>,
        Mode<ThreadStateHandling::kSwitchIfRegistered, ThreadState::kRunnable>,
        Mode<ThreadStateHandling::kSwitchIfRegistered, ThreadState::kNative>>;
    ...
    RunInNewThread([](){
...

        {
            ...
            auto expectedSecondThreadState =
                    (TypeParam::threadStateHandling == ThreadStateHandling::kSwitchIfRegistered)
                    ? ThreadState::kNative
                    : initialThreadState;
