...
class IrFileDeserializer(
    ...
    private fun loadTopLevelDeclarationProto(idSig: IdSignature): ProtoIrDeclaration {
...
abstract class IrLibraryFile {
    abstract fun declaration(index: Int): ProtoIrDeclaration
...
class IrLibraryFileFromBytes(private val bytesSource: IrLibraryBytesSource) : IrLibraryFile() {
    ...
    override fun declaration(index: Int): ProtoIrDeclaration =
        ProtoIrDeclaration.parseFrom(bytesSource.irDeclaration(index).codedInputStream, extensionRegistryLite)
