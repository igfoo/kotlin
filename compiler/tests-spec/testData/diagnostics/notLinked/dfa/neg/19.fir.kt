...
fun case_1(x: Boolean?) {
    l1@ while (true) {
        <!REDUNDANT_LABEL_WARNING!>l2@<!> while (true || x!!) {
            break@l1
        }
    }
...
fun case_8(x: Boolean?) {
    <!REDUNDANT_LABEL_WARNING!>l1@<!> while (true || x!!) {
        l2@ while (true) {
            break@l2
        }
    }
...
fun case_9(x: Boolean?) {
    l1@ while (true) {
        break@l1
        <!REDUNDANT_LABEL_WARNING!>l2@<!> while (x!!) {
...
fun case_10(x: Boolean?) {
    l1@ while (true) {
        <!REDUNDANT_LABEL_WARNING!>l2@<!> while (break@l1 || x!!) {
...
fun case_17(x: Boolean?) {
    <!REDUNDANT_LABEL_WARNING!>l1@<!> while (true) {
        l2@ while (true) {
            <!REDUNDANT_LABEL_WARNING!>l3@<!> while (break@l2 || x!!) {
...
fun case_18(x: Boolean?) {
    l1@ while (true) {
        <!REDUNDANT_LABEL_WARNING!>l2@<!> while (true) {
            <!REDUNDANT_LABEL_WARNING!>l3@<!> while (break@l1 || x!!) {
...
fun case_25(x: Boolean?) {
    l1@ for (i in listOf(1, 2, 3)) {
        <!REDUNDANT_LABEL_WARNING!>l2@<!> for (j in listOf(true || x!!, break@l1 || x!!, x!!)) {
            break@l1
        }
    }
