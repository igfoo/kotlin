...
public interface KtReferenceShortenerMixIn : KtAnalysisSessionMixIn {
    public companion object {
        ...
        /**
         * Shorten references in the given [file] and [range]. The function must be invoked on EDT thread because it modifies the underlying PSI.
         * This method analyse Kotlin code and hence could block the EDT thread for longer period of time. Hence, this method should be called only
         * to shorten references in *newly generated code* by IDE actions. In other cases, please consider using
         * [org.jetbrains.kotlin.analysis.api.components.KtReferenceShortenerMixIn] in a background thread to perform the analysis and then modify
         * PSI on the EDt thread by invoking [org.jetbrains.kotlin.analysis.api.components.ShortenCommand.invokeShortening].
         */
